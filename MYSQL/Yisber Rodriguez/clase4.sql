create database bd_catalogo_yisber;


use db_catalogo_yisber;
...
create table usuarios(
    ...
    create table usuarios_roles(
        ...
        foreign key(usuario_id) references usuarios(id) on
        update cascade,
        foreign key(rol_id) references roles (id) on update 
        cascade
    );
...
--CONSULTAS CONBINADAS ENTRE TABLAS PRODUCTOS CATEGORIAS Y ETIQUETAS
...
--consultas convinadas usando alias
