-- CREACIÓN DE LA BASE DE DATOS DEL CATALOGO
CREATE DATABASE bd_catalogo_henry;
-- CONEXIÓN A LA BASE DE DATOS CATALOGO
USE bd_catalogo_henry;
...
select productos.nombre,
       ...
       where productos.categoria_id = categorias.id and 
             productos_etiquetas.producto_id = productos.id and
...
-- CREACIÓN DE VISTA A PARTIR DE CONSULTA COMBINADA
