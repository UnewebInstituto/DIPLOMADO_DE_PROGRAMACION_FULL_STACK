...
--
-- Host: localhost    Database: bd_andy_20250802
-- ------------------------------------------------------
...
INSERT INTO `contactos` VALUES (1,'ANA MARIA','VASQUEZ','AV@GMAIL.COM','+58 212 9876543','+58 414 1234567','+58 212 7654321'),(2,'NELLY','VASZ','AV55@GMAIL.COM','+58 612 9876543','+58 414 1239567','+58 212 7654361'),(3,'YOLANDA','mesquia','333@GMAIL.COM','+58 612 111543','+58 414 1269567','+58 212 7633361'),(5,'ANA','VASQUEZ','AV@GMAIL.COM','+58 212 9876543','+58 414 1234567','+58 212 7654321');
...
INSERT INTO `materias` VALUES (1,'LOGICA DE PROGRAMACION'),(2,'HTML5 NIVEL 1'),(3,'MYSQL'),(4,'POSTGRESQL'),(5,'JAVASCRIPT'),(6,'PYTHON');
...
INSERT INTO `productos1` VALUES (1,11,'LAVADORA',800.25,12),(2,11,'NEVERA',700.50,6),(3,11,'COCINA',300.75,8),(4,11,'AA',450.00,9),(5,11,'SECADORA',600.00,8),(11,3,'FREIDORA',280.25,8),(12,3,'PARRILLERA',200.50,6),(13,3,'LAVAPLATOS',350.75,8),(14,3,'MICRONDAS',250.00,12),(15,3,'NEVERA',450.00,9),(16,4,'LAVADORA',580.75,12),(17,4,'AA',500.50,3),(18,4,'SECADORA',650.75,4),(19,4,'MICRONDAS',350.00,6),(20,4,'NEVERA',350.75,4);
...
INSERT INTO `proveedores` VALUES (1,'General Electric','AV.BRARALT','+58 2121234567','inf@ge.com'),(2,'WHIRPOOL','AV. SAN MARTIN','+58 414 9876543','inf@whirpool.com'),(3,'LG','AV. ROMULO GALLEGOS','+58 212 6543212','info@lg.com'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7654321','info@mabe.com'),(5,'SONY','AV.VICTORIA','+58 212 4234567','inf@sony.com'),(6,'PHILIPS','AV. URDANETA','+58 414 5876543','inf@philips.com'),(7,'ZENIYH','AV.NVA. GRANADA','+58 212 7543212','info@zenetih.com');
...
INSERT INTO `proveedores1` VALUES (3,'LG','AV. ROMULO GALLEGOS','+58 212 6543212','info@lg.com'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7654321','info@mabe.com'),(11,'General Electric','AV.BRARALT','+58 2121234567','inf@ge.com');
...
INSERT INTO `proveedores2` VALUES (1,'General Electric','AV.BRARALT','+58 2121234567','inf@ge.com'),(2,'WHIRPOOL','AV. SAN MARTIN','+58 414 9876543','inf@whirpool.com'),(3,'LG','AV. ROMULO GALLEGOS','+58 212 6543212','info@lg.com'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7654321','info@mabe.com'),(5,'SONY','AV.VICTORIA','+58 212 4234567','inf@sony.com'),(6,'PHILIPS','AV. URDANETA','+58 414 5876543','inf@philips.com'),(7,'ZENIYH','AV.NVA. GRANADA','+58 212 7543212','info@zenetih.com');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_prov_prod` AS select `a`.`nombre` AS `proveedor`,`a`.`telefono` AS `telefono`,`a`.`direccion` AS `direccion`,`a`.`correo` AS `correo`,`b`.`nombre` AS `producto`,`b`.`precio` AS `precio`,`b`.`existencia` AS `existencia` from (`proveedores` `a` join `productos` `b`) where `b`.`proveedor_id` = `a`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-08-16 16:44:48
