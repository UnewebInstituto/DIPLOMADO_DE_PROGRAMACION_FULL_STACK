...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2025 a las 23:07:28
...
--
-- Base de datos: `bd_catalogo_jesus`
--
...
(1, 'Electr?nica', 'Dispositivos y gadgets electr?nicos'),
(2, 'Moda', 'Ropa, calzado y accesorios'),
(3, 'Hogar', 'Art?culos para el hogar y decoraci?n'),
(4, 'Libros', 'Libros de ficci?n y no ficci?n');
...
INSERT INTO `etiquetas` (`id`, `nombre`, `descripción`) VALUES
...
(1, 1, 'Smartphone X', 799.99, 50, 'Smartphone de ?ltima generaci?n con c?mara de alta resoluci?n.'),
(2, 2, 'Camiseta de algod?n', 19.50, 200, 'Camiseta 100% algod?n, disponible en varios colores.'),
(3, 3, 'Set de sartenes antiadherentes', 85.00, 30, 'Juego de sartenes de 3 piezas para cocina.'),
(4, 4, 'El Quijote', 15.75, 150, 'Edici?n de bolsillo de la obra maestra de Cervantes.'),
(5, 1, 'Auriculares Bluetooth', 45.90, 100, 'Auriculares inal?mbricos con cancelaci?n de ruido.');
...
(1, 'Carlos', 'G?mez', 'carlos.gomez@example.com', 'eb52fc9a4b3a81a2000a9e774d5aa515'),
(2, 'Mar?a', 'L?pez', 'maria.lopez@example.com', '73a054cc528f91ca1bbdda3589b6a22d'),
(3, 'Juan', 'P?rez', 'juan.perez@example.com', '5cab168f8e24891f300bb1f1f6450e33'),
