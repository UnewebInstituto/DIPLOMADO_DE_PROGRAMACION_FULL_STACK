...
--
-- Host: localhost    Database: bd_jesus_20250802
-- ------------------------------------------------------
...
INSERT INTO `contactos` VALUES (2,'ANA MARIA','VASQUEZ','AV@GMAIL.COM','+58 212 9876543','+58 414 1234567','+58 212 7654321'),(3,'YOLANDA','TORTOZA','YT@GMAIL.COM','+58 212 3215476','+58 414 7654321','+58 212 1234567'),(4,'NELLY','CONTRERAS','NC@GMAIL.COM','+58 212 4436543','+58 414 9874567','+58 212 3364321');
...
INSERT INTO `estudiantes` VALUES (1,'ANA','VASQUEZ'),(2,'YOLANDA','TORTOZA'),(3,'LIBIA','COLS'),(4,'HERDRINA','MONASTERIOS');
...
INSERT INTO `estudiantes_materias` VALUES (1,1),(1,2),(1,3),(1,4),(1,5),(1,6),(2,2),(2,4),(2,6),(3,1),(3,6),(4,1),(4,3),(4,5);
...
INSERT INTO `materias` VALUES (1,'LOGICA DE PROGRAMACION'),(2,'HTML5 NIVEL I'),(3,'MYSQL'),(4,'POSTGRESQL'),(5,'JAVASCRIPT'),(6,'PYTHON');
...
INSERT INTO `personas` VALUES (1,'V1234','ANA','VASQUEZ','AV@GMAIL.COM','+58 414 1234567','+58 212 9876543','+58 212 7654321'),(2,'V5678','YOLANDA','TORTOZA','YT@GMAIL.COM','+58 414 7654321','+58 212 3215476','+58 212 1234567'),(3,'V9012','NELLY','CONTRERAS','NC@GMAIL.COM','+58 414 9874567','+58 212 4436543','+58 212 3364321');
...
INSERT INTO `productos` VALUES (1,1,'LAVADORA',800.25,12),(2,1,'NEVERA',800.25,6),(3,1,'COCINA',300.75,8),(4,1,'AA',450.00,9),(5,1,'SECADORA',600.00,8),(6,2,'LAVADORA',800.25,12),(7,2,'CONGELADOR',800.25,6),(8,2,'COCINA',300.75,8),(9,2,'VENTILADOR',150.00,9),(10,2,'SECADORA',750.00,8),(11,3,'FREIDORA',800.25,12),(12,3,'PARRILLERA',800.25,6),(13,3,'LAVAPLATOS',350.75,8),(14,3,'MICROONDAS',250.00,12),(15,3,'SECADORA',700.00,8),(16,4,'LAVADORA',580.75,12),(17,4,'AA',500.25,3),(18,4,'SECADORA',650.75,4),(19,4,'MICROONDAS',350.00,6),(20,4,'NEVERA',350.75,4);
...
INSERT INTO `productos1` VALUES (1,11,'LAVADORA',800.25,12),(2,11,'NEVERA',800.25,6),(3,11,'COCINA',300.75,8),(4,11,'AA',450.00,9),(5,11,'SECADORA',600.00,8),(11,3,'FREIDORA',800.25,12),(12,3,'PARRILLERA',800.25,6),(13,3,'LAVAPLATOS',350.75,8),(14,3,'MICROONDAS',250.00,12),(15,3,'SECADORA',700.00,8),(16,4,'LAVADORA',580.75,12),(17,4,'AA',500.25,3),(18,4,'SECADORA',650.75,4),(19,4,'MICROONDAS',350.00,6),(20,4,'NEVERA',350.75,4);
...
INSERT INTO `productos2` VALUES (1,1,'LAVADORA',800.25,12),(2,1,'NEVERA',800.25,6),(3,1,'COCINA',300.75,8),(4,1,'AA',450.00,9),(5,1,'SECADORA',600.00,8),(6,2,'LAVADORA',800.25,12),(7,2,'CONGELADOR',800.25,6),(8,2,'COCINA',300.75,8),(9,2,'VENTILADOR',150.00,9),(10,2,'SECADORA',750.00,8),(11,3,'FREIDORA',800.25,12),(12,3,'PARRILLERA',800.25,6),(13,3,'LAVAPLATOS',350.75,8),(14,3,'MICROONDAS',250.00,12),(15,3,'SECADORA',700.00,8),(16,4,'LAVADORA',580.75,12),(17,4,'AA',500.25,3),(18,4,'SECADORA',650.75,4),(19,4,'MICROONDAS',350.00,6),(20,4,'NEVERA',350.75,4),(21,9,'LAVADORA',580.75,12),(22,9,'AA',500.25,3),(23,9,'SECADORA',650.75,4),(24,9,'MICROONDAS',350.00,6),(25,9,'NEVERA',350.75,4);
...
INSERT INTO `proveedores` VALUES (1,'GENERAL ELECTRIC','AV. BARALT','+58 212 123465789','INFO@GE.COM'),(2,'WHIRPOOL','AV. SAN MARTIN','+58 414 9876544321','INFO@WHIRPOOL.COM'),(3,'LG','AV. ROMULO GALLEGOS','+58 212 123987456','INFO@LG.COM'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7653421','INFO@MABE.COM'),(5,'SONY','AV. VICTORIA','+58 212 4234567','info@sony.com'),(6,'PHILLIPS','AV. URDANETA','+58 414 5876543','info@phillips.com'),(7,'ZENITH','AV. NVA GRANADA','+58 212 7543212','info@zenith.com');
...
INSERT INTO `proveedores1` VALUES (3,'LG','AV. ROMULO GALLEGOS','+58 212 123987456','INFO@LG.COM'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7653421','INFO@MABE.COM'),(11,'GENERAL ELECTRIC','AV. BARALT','+58 212 123465789','INFO@GE.COM');
...
INSERT INTO `proveedores2` VALUES (1,'GENERAL ELECTRIC','AV. BARALT','+58 212 123465789','INFO@GE.COM'),(2,'WHIRPOOL','AV. SAN MARTIN','+58 414 9876544321','INFO@WHIRPOOL.COM'),(3,'LG','AV. ROMULO GALLEGOS','+58 212 123987456','INFO@LG.COM'),(4,'MABE','AV. FRANCISCO DE MIRANDA','+58 212 7653421','INFO@MABE.COM'),(5,'SONY','AV. VICTORIA','+58 212 4234567','info@sony.com'),(6,'PHILLIPS','AV. URDANETA','+58 414 5876543','info@phillips.com'),(7,'ZENITH','AV. NVA GRANADA','+58 212 7543212','info@zenith.com');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_prov_prod` AS select `a`.`nombre` AS `proveedor`,`a`.`telefono` AS `telefono`,`b`.`nombre` AS `nombre`,`b`.`precio` AS `precio`,`b`.`existencia` AS `existencia` from (`proveedores` `a` join `productos` `b`) where `b`.`proveedor_id` = `a`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_prov_prod_inner_join` AS select `a`.`nombre` AS `proveedor`,`a`.`telefono` AS `telefono`,`b`.`nombre` AS `nombre`,`b`.`precio` AS `precio`,`b`.`existencia` AS `existencia` from (`proveedores` `a` join `productos` `b` on(`a`.`id` = `b`.`proveedor_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_prov_prod_left_join` AS select `a`.`nombre` AS `proveedor`,`a`.`telefono` AS `telefono`,`b`.`nombre` AS `nombre`,`b`.`precio` AS `precio`,`b`.`existencia` AS `existencia` from (`proveedores` `a` left join `productos` `b` on(`a`.`id` = `b`.`proveedor_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_prov_prod_right_join` AS select `a`.`nombre` AS `proveedor`,`a`.`telefono` AS `telefono`,`b`.`nombre` AS `nombre`,`b`.`precio` AS `precio`,`b`.`existencia` AS `existencia` from (`productos2` `b` left join `proveedores2` `a` on(`a`.`id` = `b`.`proveedor_id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_resumen_productos` AS select distinct `vista_prov_prod`.`nombre` AS `nombre`,min(`vista_prov_prod`.`precio`) AS `MIN(precio)`,max(`vista_prov_prod`.`precio`) AS `MAX(precio)`,avg(`vista_prov_prod`.`precio`) AS `AVG(precio)`,`vista_prov_prod`.`existencia` AS `existencia` from `vista_prov_prod` group by `vista_prov_prod`.`nombre` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_resumen_proveedores` AS select distinct `vista_prov_prod`.`proveedor` AS `proveedor`,min(`vista_prov_prod`.`precio`) AS `MIN(precio)`,max(`vista_prov_prod`.`precio`) AS `MAX(precio)`,avg(`vista_prov_prod`.`precio`) AS `AVG(precio)`,`vista_prov_prod`.`existencia` AS `existencia` from `vista_prov_prod` group by `vista_prov_prod`.`proveedor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-08-16 17:09:50
