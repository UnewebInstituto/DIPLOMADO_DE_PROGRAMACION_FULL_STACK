...
while True:
    ...
    for contenido_encuesta in data_encuesta:
        ...
        print("---")
        # Se acumula edad, peso y estatura y eval lo convierte en entero para sumar
    ...
    """
    # Primera forma:
    print("Edad: %.2f" %promedio_edad)
    print("Peso: %.2f" %promedio_peso)
    print("Estatura: %.2f" %promedio_estatura)
    ...
    print("---")
    respuesta = input("¿Desea volver a ver nuevamente el contenido del reporte (S/N)?:")
